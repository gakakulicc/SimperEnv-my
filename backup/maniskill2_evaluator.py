...
def run_maniskill2_eval_single_episode(
    ...
    print(f"episode {obj_episode_id}: Initializing environment with {env_name}/n")
    print(f"episode {obj_episode_id}: Renderer kwargs: {kwargs}/n")
    ...
    # env.close() #Debug: RuntimeError: vk::PhysicalDevice::createDeviceUnique: ErrorExtensionNotPresent
    # gc.collect()

    
    print(f"episode {obj_episode_id}: Initializing environment with {env_name}/n")
    print(f"episode {obj_episode_id}: Renderer kwargs: {kwargs}/n")
    print(f"episode {obj_episode_id}: Success count so far: {success}/n")
